...
PLACEHOLDER_RE='(EXAMPLE|example|test|fake|placeholder|1234567890abcdef|abc123|def456|hunter2|my_super_secret|sk-xxxx|sk-xxx|sk-[x]{10,}|ghp_[x]{10,}|MIIEpQIBAAKCAQEA|MIIEpQIBAAK|ABCDEFG|b3BlbnNzaC1rZXktdjE|GM_EXAMPLE_PROVIDER_API_KEY|self\.api_key|\{self\.api_key\}|os\.environ\.get|YOUR_.*_KEY_HERE|REPLACE_ME|CHANGEME)'
