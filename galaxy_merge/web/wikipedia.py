...
def search_wikipedia(query: str, lang: str = "en", max_results: int = 5) -> list[dict[str, Any]]:
...
def get_wikipedia_summary(title: str, lang: str = "en", sentences: int = 3) -> dict[str, Any]:
